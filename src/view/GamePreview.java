...
public class GamePreview {
    ...
    public GamePreview(Match match, Jeu jeu){
        this.match=match;
        ...
        titleText.setStyle(
            "-fx-fill: #F2F2F2 ;" +  // Dégradé vert clair à vert foncé
        ...
        startButton.setStyle(
            "-fx-background-color: #F2F2F2 ;" +  // Dégradé vert (vert clair à vert foncé)
            "-fx-text-fill: black;" +                                               // Texte en blanc
            ...
            "-fx-border-color: #000000;" +                                          // Bordure noire
            "-fx-border-width: 5px;" +                                              // Largeur de la bordure
        ...
        StackPane.setMargin(startButton, new javafx.geometry.Insets(500, 0, 100, 0));
